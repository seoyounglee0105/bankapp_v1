...
<div class="col-sm-8">
	...
	<div class="bg-light p-md-5 h-75">
		...
		<br>
		<a href="https://kauth.kakao.com/oauth/authorize?client_id=bd2e1dbb477ff324001caadfd0bc7f33&redirect_uri=http://localhost:8080/auth/kakao/callback&response_type=code">
