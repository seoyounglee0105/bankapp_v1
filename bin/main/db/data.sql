...
INSERT INTO user_tb(username, password, fullname, created_at) values('홍아', '1234', '항아', now());

-- 계좌 샘플 데이터
INSERT INTO account_tb(number, password, balance, user_id, created_at) values('1111', '1234', 1200, 1, now());
INSERT INTO account_tb(number, password, balance, user_id, created_at) values('2222', '1234', 2200, 2, now());
